...
export default function Websites(props) {
    ...
    return (
        <Grid container direction="column" >
                 ...
                 <Grid item container direction="column" className={classes.heading}>
                     ...
                     <Grid item>
                         <Typography align={matchesMD ? "center" : undefined} variant="body1" paragraph>
                             Having a website is a neccessity in today's business world. They give you one 
                             central, public location to let people know who you are, what you do, and why you're the
                             best at it.
                         </Typography>
                         <Typography align={matchesMD ? "center" : undefined} variant="body1" paragraph>
                           From simply having your hours posted to having a full fledged online store , mking yourself as 
                           accessible as possile to users online drives growth and enables you to reach new customers.
                        </Typography>
            ...
            <Grid   
                item container direction={matchesXS ? "column" : "row"} alignItems="center"
                className={classes.rowContainer}
                ...
                <Grid item>
                    <Grid item container direction="column">
                        ...
                        <Grid item>
                            ...
                            alt="graph with magnifying revealying 1's and 0's" />
                        </Grid>
                    </Grid>                
                </Grid>
            ...
            <Grid item container direction={matchesXS ? "column" : "row"} alignItems="center" 
                justify="flex-end" 
                className={classes.rowContainer} 
            ...
            <Grid item container direction={matchesXS ? "column" : "row"} alignItems="center" className={classes.rowContainer} >
                <Grid item>
                    <Grid item container direction="column">
                        <Grid item>
                ...
                <Grid item className={classes.paragraphContainer}  style={{marginLeft: matchesSM ? 0: "1em"}}>
                    <Typography align={matchesSM ? "center" : undefined}  variant="body1" >
                        ...
                        customers decide what's right for them before visisting in person.
                    </Typography>
                </Grid>
          </Grid>
          ...
          <Grid item container direction="row" alignItems="center"
           ...
           className={classes.rowContainer} >
                ...
                <Grid item style={{marginLeft: matchesSM ? 0:  "1em"}} className={classes.paragraphContainer} >
                    <Typography align={matchesSM ? "center" : undefined}  variant="body1" paragraph >
                        How often have your ever been to the second page of Google results? 
                    </Typography>
                    <Typography align={matchesSM ? "center" : undefined}  variant="body1" paragraph >
