...
export default function LandingPage(props) {
    ...
    return (
        ...
        {" "}
        {/*----- Websites Block-----*/}
        <Grid container justify={matchesSM ? "center" : undefined} irection="row" className={classes.servicesContainer}>
            <Grid item style={{marginLeft: matchesSM ? 0 : "5em" , textAlign: matchesSM ? "center" : undefined}}>
                <Typography variant="h4">
...
<Grid item>
    ...
    <Grid
     ...
     >
         <Grid item container style={{textAlign: matchesSM ? "center" : "inherit"}}
        ...
        <Grid item sm 
        style={{marginRight:matchesSM? 0: matchesSM ? "2em" : "5em", textAlign: matchesSM ? "center" : "right"}}>
